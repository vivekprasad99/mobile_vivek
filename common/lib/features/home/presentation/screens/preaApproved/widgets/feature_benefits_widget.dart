...
class FeatureBenefitsWidget extends StatelessWidget {
  const FeatureBenefitsWidget({super.key, this.offerTabDetails});
    ...
    return BlocBuilder<LandingPageCubit, LandingPageState>(
      ...
      builder: (context, state) {
        return Column(
          children: [
            ListView.builder(
                itemCount: offerTabDetails?.featuresList?.length,
                shrinkWrap: true,
                  ...
                  return SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                            offerTabDetails?.featuresList?[index].toString() ??
                                '',
