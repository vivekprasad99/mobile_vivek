...
class FAQTitleTextHighlighter extends StatelessWidget {
  const FAQTitleTextHighlighter(
  ...
  Widget _buildHighlightedText(
    ...
    if (queryWords.isEmpty) {
      return Text(text, style: Theme.of(context).textTheme.labelLarge?.copyWith(fontWeight: FontWeight.w400));
    }

    final RegExp regExp = RegExp(queryWords.map((word) => RegExp.escape(word)).join('|'), caseSensitive: false);
