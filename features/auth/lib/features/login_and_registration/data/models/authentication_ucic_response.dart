class AuthenticateMultiUcicResponse {
  String? code;
  String? message;
  String? userFullName;
  String? ucic;
  ...
  AuthenticateMultiUcicResponse({this.code, this.message,this.userFullName, this.ucic, this.uniqueUcicFound, this.responseCode, this.lanAsPerDataLake, this.panAsPerDataLake});

  AuthenticateMultiUcicResponse.fromJson(Map<String, dynamic> json) {
    code = json['code'];
