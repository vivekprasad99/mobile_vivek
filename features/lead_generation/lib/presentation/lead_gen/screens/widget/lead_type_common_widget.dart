...
class LeadTypeCommonWidget extends StatefulWidget {
  const LeadTypeCommonWidget(
      {super.key, required this.leadTypeCode, required this.title});

  final String leadTypeCode;
  final String title;

  @override
  State<LeadTypeCommonWidget> createState() => _LeadTypeSmeWidgetState();
}

class _LeadTypeSmeWidgetState extends State<LeadTypeCommonWidget> {
