...
class LeadTypeVehicleTopUp extends StatefulWidget {
  final bool isVehicle;
  const LeadTypeVehicleTopUp({super.key, required this.isVehicle});

  @override
  LeadTypeVehicleTopUpState createState() => LeadTypeVehicleTopUpState();
}

class LeadTypeVehicleTopUpState extends State<LeadTypeVehicleTopUp> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: customAppbar(
        ...
        context: context,
        title: getString(widget.isVehicle ? lblVehicleTopUp : lblPersonalTopUp),
        onPressed: () {
          context.pop();
        },
      ),
  ...
  Widget _buildPinCode() {
    return CustomFloatingTextField(
      ...
      helperText: getString(lblPleaseEnterSixPincode),
      maxLength: 6,
      controller: _pinCodeController,
      labelText: getString(labelEnterPinCode2),
      helperTextstyle: Theme.of(context).textTheme.labelSmall,
      textStyle:
