...
class ServiceRequestRaised extends StatelessWidget {
  final ServiceRequestResponse serviceRequestResponse;

  const ServiceRequestRaised({super.key, required this.serviceRequestResponse});
      ...
      body: MFGradientBackground(
        child: Column(
          ...
          children: [
            ...
            Text(
              getString(serviceBureauRequestRaised),
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(
                          "${getString(serviceBureauTicketNo)} ${serviceRequestResponse.data?.serviceTicketNumber}",
                    ...
                    MfCustomButton(
                        onPressed: () {
                          SRDetailsRequest srDetailsReq = SRDetailsRequest(
                              caseNumber: serviceRequestResponse
                                  .data?.serviceTicketNumber);
                          context
