...
import 'package:fintogo/config/feature_flag/feature_flag_prod.dart';
...
void main(){
  ...
  runZonedGuarded(() async {
    ...
    await dotenv.load(fileName: 'mobile-config/common/prod.env');
    AppConfig.create(
        appName: "MF",
        baseUrl: "https://mfapp.com",
        apiSuffix: "/oneapp-sit/api/mobile/v1/",
        msSuffix: "/oneapp-sit/api/mobile/v1/",
